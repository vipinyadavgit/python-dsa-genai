...
9. Bernoulli Distribution (Pending)
10. Binomial Distribution (Pending)
11. Skewness
12. Kurtosis
13. Mean
14. Median
15. Mode
16. Missing Value Replacement
17. Range
18. IQR
19. Variance
20. Standard Deviation
21. Variance vs Standard Deviation
22. Population vs Sample Variance
...
1. Bernoulli Distribution (Pending)
2. Binomial Distribution (Pending)
...
1. AI vs ML vs Deep Learning vs Data Science
...
8. Classification
9. Regression
10. Classification vs Clustering
...
20. K-Nearest Neighbour
21. Euclidean Distance
22. Manhattan Distance
23. Selecting Optimal K
24. Elbow / Validation Curve
...
=========================================================
MODULE 11 : ML ALGORITHM SELECTION & MODEL BUILDING
=========================================================

Part 1 : Problem Understanding

1. How to understand an ML problem
2. Define Business Problem
3. Define Target Variable
4. Identify Features
5. Identify Data Type
...
Part 4 : How to Select an Algorithm
...
1. What is Baseline Model?
2. Why always start simple?
3. Why Linear/Logistic Regression first?

---------------------------------------------------------

Part 6 : Training Multiple Models

1. Why train multiple models?
2. Which models should we compare?
3. Model comparison workflow
4. Avoid selecting by accuracy alone

---------------------------------------------------------

Part 7 : Choosing Evaluation Metrics
...
1. When to tune?
2. Which model to tune?
3. Grid Search
4. Random Search

---------------------------------------------------------

Part 10 : Final Model Selection
...
Part 11 : End-to-End Case Studies
...
For each case study we will answer:
...
• Which algorithm?
• Which metrics?
• Train how many models?
• Compare models?
• Final recommendation?

Part 12: Algorithm Selection Playbook
...
Time Series?
        │
        ▼
Sequence Models / Forecasting Methods

Part 13: Algorithm Selection Playbook

---------------------------------------------------------

Part 13 : Algorithm Selection Playbook

The goal of this section is NOT to memorize algorithms.

The goal is to think like an ML Engineer.
...
STEP 12 : ML Engineer Thinking Checklist

Before building any ML model ask yourself:

1. What is the business problem?
2. What type of ML problem is this?
3. What preprocessing is required?
4. Do I need Feature Engineering?
5. Which algorithm should be my baseline?
6. Which additional algorithms should I compare?
7. Which evaluation metric is most appropriate?
8. Should I optimize for accuracy, speed, explainability, or cost?
9. Which model should I deploy?
10. How will I monitor and improve it after deployment?
=========================================================
